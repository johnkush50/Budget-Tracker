...
function updateCategoryBreakdown(categoryData, total, container) {
    ...
    categoryData.forEach(category => {
        ...
        nameSpan.textContent = formatCategoryName(category.category);
        
        const valueSpan = document.createElement('span');
        valueSpan.className = 'category-value';
        valueSpan.textContent = formatCurrency(category.amount);
        ...
        progressBar.style.backgroundColor = categoryColor;
